...
<div class="boxcenter">
    <div class="termo">
        ...
        Bem-vindo(a) ao Remartech (“Plataforma”). Ao acessar ou utilizar a Plataforma, você concorda em cumprir e estar vinculado aos seguintes Termos de Uso (“Termos”), juntamente com nossa Política de Privacidade. Caso não concorde com estes Termos, não utilize nossos serviços.

        A Remartech é uma plataforma digital que conecta técnicos de informática (“Técnicos”) com usuários interessados em contratar serviços de manutenção e suporte em equipamentos de informática e eletrônicos (“Usuários”).

        <h3 class="tema">2. DEFINIÇÕES</h3>
        Para os efeitos destes Termos, os seguintes termos terão os significados indicados:

        Plataforma: O site e/ou aplicativo Remartech, por meio do qual é prestado o serviço de intermediação entre Técnicos e Usuários.
        ...
        A Remartech atua exclusivamente como intermediária, não se responsabilizando diretamente pela execução dos serviços prestados pelos Técnicos.
        ...
        Os Técnicos também deverão se cadastrar, submetendo informações profissionais que serão verificadas pela Plataforma. A Remartech se reserva o direito de recusar ou suspender cadastros que não atendam aos requisitos de qualidade e segurança.

        <h3 class="tema">5. RESPONSABILIDADES DA PLATAFORMA</h3>
        A Remartech compromete-se a:
        ...
        A negociação e o pagamento pelos serviços prestados são realizados diretamente entre Usuários e Técnicos. A Remartech não participa do processamento de pagamentos, exceto quando houver previsão em contrato específico para intermediação de pagamentos.

        <h3 class="tema">8. LIMITAÇÃO DE RESPONSABILIDADE</h3>
        A Remartech não garante a execução ou qualidade dos serviços prestados pelos Técnicos, não sendo responsável por quaisquer prejuízos decorrentes de falhas, atrasos ou má execução dos serviços.
        ...
        Todos os direitos relativos à Plataforma, incluindo, mas não se limitando a textos, imagens, marcas e logotipos, são de propriedade exclusiva da Remartech ou de seus licenciadores, estando protegidos pelas leis de propriedade intelectual. O uso da Plataforma não concede ao Usuário ou Técnico quaisquer direitos sobre tais conteúdos.

        <h3 class="tema">10. MODIFICAÇÕES NOS TERMOS DE USO</h3>
        A Remartech se reserva o direito de modificar estes Termos a qualquer momento, mediante aviso prévio aos Usuários e Técnicos. As modificações entrarão em vigor após a publicação na Plataforma, e o uso contínuo da Plataforma será considerado como aceitação dos novos Termos.
